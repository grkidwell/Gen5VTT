...
#and read_imon_vector
    ...
    def load_share(self,testcurrent):
        sorensen_maxload = 50
        sorensen_current    = min(sorensen_maxload,testcurrent)
        vtt_current         = testcurrent - sorensen_current
        imon_sorensen = self.load_sorensen(sorensen_current)
        imon_vtt      = self.load_vtt(vtt_current)
        return imon_sorensen+imon_vtt
